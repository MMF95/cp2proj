...
function clearOut() {
document.game.player.value="0";
document.game.server.value="0";
...
server=Math.round((choice-1)*aRandomNumber)+1;
if (server==1) temp="A";
if (server==2) temp="B";
if (server==3) temp="C";
if (server==4) temp="D";
...
if (all==2){ alert("Hola! I win!"); ls++; }
if (all==3){ alert("We tied."); ts++; }
if (all!=0) {
document.game.player.value = wn;
document.game.server.value = ls;
